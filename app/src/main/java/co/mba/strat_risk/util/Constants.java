...
public class Constants {
    ...
    public static final Integer RISK_STATUS = 2;
    public static final Integer INTERESTING_STATUS = 3;
    ...
    public static final String EXTRA_EMAIL = "strat-risk@mbariesgos.com";
